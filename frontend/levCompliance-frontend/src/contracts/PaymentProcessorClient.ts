...
export type PaymentProcessorComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<PaymentProcessorComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<PaymentProcessorComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<PaymentProcessorComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
