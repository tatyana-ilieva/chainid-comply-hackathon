    ...
    global: {
      ...
      getAll: async (): Promise<Partial<Expand<GlobalKeysState>>> => {
        ...
        return {
          ...
          contractPaused: new BinaryStateValue(result.contract_paused),
       ...
       */
      contractPaused: async (): Promise<BinaryState> => { return new BinaryStateValue((await this.appClient.state.global.getValue("contract_paused")) as Uint8Array | undefined) },
      /**
