...
def test_says_hello(identity_registry_client: IdentityRegistryClient) -> None:
    result = identity_registry_client.send.hello(args=("World",))
...
def test_simulate_says_hello_with_correct_budget_consumed(
    ...
    result = (
        identity_registry_client.new_group()
        .hello(args=("World",))
        .hello(args=("Jane",))
        .simulate()
    )
